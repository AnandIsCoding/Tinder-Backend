...
function AllRequests() {
  return (
    <div className='w-full min-h-screen flex flex-col text-white items-center gap-5 overflow-y-auto'>
            ...
            {/* all requests */}
            <div className='min-h-[6vw] rounded-lg w-[40%] flex bg-white'>
                ...
                <div className='w-[53%] min-h-full px-6 py-4'>
                  <h2 className='text-xl font-bold text-black'>Name of requester</h2>
                  <p className='text-black'>Here bio will be displayed</p>
                </div>
