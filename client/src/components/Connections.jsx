...
function Connections() {
  ...
  return (
    <div className='w-full h-full flex flex-col justify-center gap-4'>
        ...
        {
            connections && connections.length < 1 ? <h1 className='text-white text-4xl text-center absolute top-[10vw] left-[30vw] underline'>No Connections Found</h1> : connections && connections.map((item,index)=>{
              return  <div key={item._id} className='min-h-[6vw] w-[100%]  rounded-lg md:w-[40%] flex items-center mx-auto bg-white '>
                ...
                <div className='w-[72%] min-h-full px-6 py-2 text-black'>
                  ...
                  <p className='text-black'>{item.bio ? item.senderId.bio : 'Bio not available' }</p>
