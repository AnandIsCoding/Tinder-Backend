...
function Feed() {
  ...
  return (
     <div className='flex justify-center z-[999]'>
      <div className='bg-white shadow-sm   shadow-violet-200 w-[90%] md:w-[25%] h-[80vh] md:h-[82vh] rounded-xl mt-[22vw] md:mt-[5vw] overflow-auto'>
        <div className='w-full h-[65%] rounded-t-xl bg-pink-200 '>
          <img src='https://img.freepik.com/premium-photo/indian-asian-man-giving-multi-pal-expression-white-background_54391-3497.jpg?w=360' alt='user_image' className='w-full h-full object-cover'/>
        </div>
